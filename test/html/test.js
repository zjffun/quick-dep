...
function test(source, dependencies) {
  assert.deepEqual(detective(source, { html: true }), dependencies);
}
...
describe("detective-html", () => {
  ...
  describe("html", () => {
    // TODO: impl
    it.skip("returns the dependencies of the given .html file content", () => {
      const htmlStr = fs
